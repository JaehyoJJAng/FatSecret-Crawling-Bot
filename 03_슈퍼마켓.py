...
class Application:
    def __init__(self):
        self.word_list = get_word_list('word_list')
    ...
    def run(self)-> list:
        ...
        # 브랜드별 상세페이지 링크 추출
        detail_links : list = self.get_detail_link(links=links)

        # 상세페이지 내 데이터 추출
        results : list = self.get_content(detail_links=detail_links)
    ...
    def get_food_link(self)-> list:
        ...
        for word in self.word_list:
            ...
            URL = f'https://www.fatsecret.kr/Default.aspx?pa=brands&f={word}&t=3'
    ...
    def get_detail_link(self,links: list)-> list:
        detail_link_list = []
        base_url = 'https://www.fatsecret.kr'
    ...
    def get_content(self,detail_links: list)-> list :
        save_data = []
